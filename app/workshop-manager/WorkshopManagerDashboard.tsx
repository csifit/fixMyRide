...
export default function WorkshopManagerDashboard({ displayName, providers, lowStockCount, logoutAction }: { displayName: string; providers: ManagedServiceProvider[]; lowStockCount: number; logoutAction: () => Promise<void> }) {
