...
export default function WorkshopManagerDashboard({ displayName, providers, lowStockCount, dueReminderCount, openQualityCaseCount, logoutAction }: { displayName: string; providers: ManagedServiceProvider[]; lowStockCount: number; dueReminderCount: number; openQualityCaseCount: number; logoutAction: () => Promise<void> }) {
